export const ENEM_CONTENT = {

  "Matemática": {
    color: "#B45309", colorLight: "#FEF3C7",
    "Matemática Básica": {
    ...
    "Matemática 1 — Funções e Álgebra": {
    ...
    "Matemática 3 — Combinatória e Estatística": {
      "Princípio Fundamental da Contagem (PFC)": [],
      "Fatorial": [],
      "Arranjo": [],
      "Permutação simples e Permutação circular": [],
      "Combinação": [],
      "Estatística — Organização e Representação de dados": [],
  ...
  "Química": {
    color: "#047857", colorLight: "#D1FAE5",
    "Química 1 — Geral e Inorgânica": {
      "Modelos atômicos": [],
      ...
      "Poluição ambiental, Efeito estufa e Chuvas ácidas": [],
      "Estudo dos ácidos": [],
      "Estudo das bases": [],
      ...
      "Estudo dos óxidos": [],
      "Reações inorgânicas": [],
      "Grandezas químicas e Fórmulas químicas": [],
      "Balanceamento de reações": [],
      "Cálculo estequiométrico": [],
      "Reagente limitante ou em excesso": [],
      "Pureza e Rendimento": [],
      "Variáveis de estado e Transformações gasosas": [],
      "Densidade, Efusão e Difusão de gases": [],
      "Mistura dos gases": [],
    },
    "Química 2 — Físico-Química": {
      ...
      "Cinética química — Visão geral": [],
      "Cinética química — Velocidade média e Lei da velocidade": [],
      "Equilíbrio químico — Noções e cálculos": [],
      "Deslocamento de equilíbrio": [],
      "Equilíbrio iônico e Produto de Solubilidade": [],
      "pH e pOH": [],
      "Hidrólise de sais": [],
    ...
    "Química 3 — Orgânica": {
      ...
      "Esterificação, Transesterificação e Hidrólise": [],
      "Polímeros": [],
      "Biomoléculas": [],
    },
  },
  ...
  "Biologia": {
    color: "#065F46", colorLight: "#ECFDF5",
    "Biologia 1 — Citologia e Genética": {
      "Introdução à Biologia e Método Científico": [],
      ...
      "Vitaminas": [],
      "Ácidos nucleicos": [],
      "Introdução à citologia e Modelos celulares": [],
      "Membrana plasmática — Classificação e Fisiologia": [],
      "Membrana plasmática — Transporte passivo e ativo": [],
      "Citoplasma — Citoesqueleto e Ribossomos": [],
      "Citoplasma — Retículo endoplasmático e Complexo de Golgi": [],
      "Citoplasma — Lisossomos, Peroxissomos, Centríolos e Mitocôndrias": [],
      "Citoplasma — Plastos, Cloroplastos e Vacúolo": [],
      ...
      "Herança sexual": [],
      "Linkage e mapeamento de genes": [],
      "Engenharia genética, genoma e biotecnologia": [],
    },
    "Biologia 2 — Embriologia, Histologia e Fisiologia": {
      "Fecundação, segmentação e clivagem": [],
    ...
    "Biologia 3 — Zoologia, Botânica e Ecologia": {
      "Poríferos": [],
      "Cnidários": [],
      "Platelmintos e verminoses": [],
      "Nematelmintos e verminoses": [],
      "Anelídeos": [],
      "Artrópodes": [],
      "Moluscos": [],
      "Equinodermos": [],
      ...
      "Ciclo reprodutivo dos vegetais": [],
      ...
      "Histologia vegetal": [],
      "Fisiologia e Transpiração vegetal": [],
      "Hormônios e Movimentos vegetais": [],
      "Origem da vida": [],
      "Teorias evolutivas": [],
      "Genética das populações e Lei de Hardy-Weinberg": [],
      "Especiação": [],
      "Evolução dos primatas e humana": [],
      "Introdução à ecologia": [],
      "Dinâmica populacional e Potencial biótico": [],
  ...
  "Física": {
    ...
    "Física 1 — Mecânica": {
      "Vetores": [],
      "Ordem de grandeza e Sistemas de unidades": [],
      ...
      "Estática de um corpo extenso e Centro de massa": [],
      "Dinâmica do movimento circular": [],
      "Trabalho": [],
      "Energia mecânica, potência e rendimento": [],
      ...
      "Densidade, pressão e Teorema de Stevin": [],
      "Teorema de Pascal e Prensa hidráulica": [],
      "Princípio de Arquimedes": [],
    },
    "Física 2 — Óptica, Ondas e Termologia": {
      "Luz e Câmara de orifício": [],
  ...
  "História": {
    color: "#92400E", colorLight: "#FEF3C7",
    "História Geral": {
      "Historiografia e Linha do tempo": [],
      "Pré-História": [],
      "Egito e Mesopotâmia": [],
      "Hebreus e Persas": [],
      "Fenícios e Cretenses": [],
      "Grécia Antiga": [],
      "Roma Antiga": [],
      "Alta Idade Média — Sistema Feudal e Igreja medieval": [],
      "Idade Média no Oriente e Civilização muçulmana e Cruzadas": [],
      "Transição feudo-capitalista": [],
      "Baixa Idade Média": [],
      "Antigo Regime — Absolutismo e Mercantilismo": [],
      "Reformas religiosas, Liberalismo e Iluminismo": [],
      ...
      "Revolução Russa": [],
      "Crise de 1929": [],
      "Período entre guerras e Totalitarismo": [],
  ...
  "Geografia": {
    ...
    "Geografia 1 — Física e Humana": {
      "Orientação e Coordenadas geográficas": [],
      "Cartografia — Elementos, Escalas e Convenções": [],
      ...
      "Recursos hídricos e Bacias hidrográficas do Brasil": [],
      "Atmosfera e Fatores climáticos": [],
      "Dinâmica dos ventos e Zonas climáticas da Terra": [],
      ...
      "Espaço geográfico": [],
      "Urbanização e Hierarquias urbanas": [],
      ...
      "Fatores do desenvolvimento e Indicadores sociais": [],
    },
    "Geografia 2 — Regiões e Geopolítica": {
      "Região Sul": [],
      "Região Sudeste": [],
      "Região Norte": [],
      "Região Nordeste": [],
      ...
      "Comércio no Brasil": [],
      "Sistemas agrícolas": [],
      "Revolução verde, Transgênicos e Agronegócio": [],
  ...
  "Filosofia": {
    ...
    "Filosofia": {
      ...
      "Filosofia Medieval": [],
      "Filosofia Renascentista e Revolução científica": [],
  ...
  "Sociologia": {
    color: "#BE185D", colorLight: "#FCE7F3",
    "Sociologia": {
      ...
      "Estratificação, Classe e Mobilidade social": [],
  ...
  "Artes e Educação Física": {
    color: "#9D174D", colorLight: "#FCE7F3",
    "Artes": {
      ...
      "Arte Moderna — Impressionismo e outros movimentos": [],
      "Arte Moderna — Vanguardas europeias": [],
  ...
  "Redação": {
    ...
    "Estrutura e Competências": {
      ...
      "Introdução e apresentação da tese": [],
    ...
    "Temas de Redação": {
      ...
      "Tecnologia, Internet, Mídias sociais e Fake news": [],
      "Envelhecimento e Previdência social": [],
      "Saúde pública e Doação de órgãos": [],
      "Fome, Desigualdade e População de rua": [],
      "Intolerância, racismo, assédio e preconceito": [],
      "Bullying e violência nas escolas": [],
      "Exclusão digital": [],
      "Consumismo": [],
      "Culto ao corpo e obesidade": [],
      "Trabalho e realização": [],
      "Povos indígenas": [],
      "Lixo e saneamento": [],
      "Mobilidade urbana": [],
      "Educação e Leitura": [],
      "Guerras e armas de destruição em massa": [],
      "Suicídio, depressão e solidão": [],
      "Sistema prisional e violência": [],
      "Meio ambiente e Mudanças climáticas": [],
      "Recursos hídricos, Energia e Sustentabilidade": [],
      "Drogas": [],
...
export const AREAS = Object.keys(ENEM_CONTENT);

export const AREA_COLORS = Object.fromEntries(
  Object.entries(ENEM_CONTENT).map(([area, val]) => [
    area,
    { bg: val.color, light: val.colorLight, text: val.color }
  ])
);
